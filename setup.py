    ...
    setup(name='avocado-framework',
          ...
          entry_points={
              'console_scripts': [
                  ...
                  'avocado-runner-noop = avocado.core.runners.noop:main',
                  'avocado-runner-dry-run = avocado.core.runners.dry_run:main',
                  'avocado-runner-exec-test = avocado.core.runners.exec_test:main',
                  'avocado-runner-python-unittest = avocado.core.runners.python_unittest:main',
                  ...
                  'avocado-runner-asset = avocado.core.runners.asset:main',
                  'avocado-runner-package = avocado.core.runners.package:main',
              ...
              'avocado.plugins.runnable.runner': [
                  ...
                  'noop = avocado.core.runners.noop:NoOpRunner',
                  'dry-run = avocado.core.runners.dry_run:DryRunRunner',
                  'exec-test = avocado.core.runners.exec_test:ExecTestRunner',
                  'python-unittest = avocado.core.runners.python_unittest:PythonUnittestRunner',
                  'asset = avocado.core.runners.asset:AssetRunner',
                  'package = avocado.core.runners.package:PackageRunner',
