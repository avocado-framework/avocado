...
class CitTests(unittest.TestCase):
    ...
    def test_compute_hamming_distance(self):
        ...
        self.assertEqual(
            expected_distance,
            self.cit.compute_hamming_distance(row),
    ...
    def test_change_one_value_random(self):
        ...
        self.assertNotEqual(
            final_matrix[row_index][column_index[0]],
            row[column_index[0]],
    ...
    def test_change_one_value_with_index(self):
        ...
        if function_state:
            self.assertEqual(
                expected_column_index, column_index[0], "Column index is wrong"
            )
    ...
    def test_change_one_column(self):
        ...
        expected_total_covered_more_than_ones = (
    ...
    def test_get_missing_combination_random(self):
        ...
        self.assertEqual(
            0,
            self.cit.combination_matrix.hash_table[combination_parameters].hash_table[
                combination
            ],
    ...
    def test_cover_missing_combination(self):
        ...
        self.assertTrue(
            final_matrix[row_index][parameters[0]] != row[parameters[0]]
            or final_matrix[row_index][parameters[1]] != row[parameters[1]],
            "Value did not change",
        )
