...
class ResultUploadCLI(CLI):
    ...
    def configure(self, parser):
        ...
        try:
            ...
            def_ssh = 'ssh LogLevel=error -o stricthostkeychecking=no'
            def_ssd = def_ssh + ' -o userknownhostsfile=/dev/null'
            def_ssh = def_ssh + ' -o batchmode=yes -o passwordauthentication=no'
