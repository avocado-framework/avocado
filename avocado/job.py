...
class Job(object):
    ...
    def __init__(self, args=None):
        ...
        if self.args is not None:
            ...
            self.multiplex_files = args.multiplex_file
    ...
    def _run(self, urls=None, multiplex_files=None):
        ...
        if multiplex_files is None:
            if self.args and self.args.multiplex_file is not None:
                multiplex_files = [os.path.abspath(_)
                                   for _ in self.args.multiplex_file]
        else:
            multiplex_files = [os.path.abspath(_) for _ in multiplex_files]
        ...
        if multiplex_files is not None:
            ...
            if urls is not None:
                for url in urls:
                    try:
                        mux_variants = multiplexer.create_variants_from_yaml
                        variants = mux_variants(multiplex_files,
