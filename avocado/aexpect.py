...
Aexpect provides ways to programatically interact with interactive processes,
such as ssh connections, GDB prompts and similar programs, one task that is
historically provided by languages such as expect
...
class Spawn(object):
    ...
    def __init__(self, command=None, a_id=None, auto_close=False, echo=False,
        ...
        """
        self.a_id = a_id or crypto.get_random_string(8)
        self.log_file = None
    ...
    def get_stripped_output(self):
        ...
        """
        return misc.strip_console_codes(self.get_output())
    ...
    def is_defunct(self):
        ...
        """
        return process.is_zombie(self.get_pid())
...
class Expect(Tail):
    ...
    def read_until_output_matches(self, patterns, filter_func=lambda x: x,
        ...
        if misc.wait_for(lambda: not self.is_alive(), 5, 0, 0.1):
