...
from avocado.virttest.propcan import PropCanBase
from avocado.virttest.libvirt_xml import xcepts, base
# The backports module will take care of picking the builtin if available
from avocado.virttest.staging.backports import bin
