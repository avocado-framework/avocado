...
cpuid_params = {'_name_map_file': {'guest-hw.cfg': '(image_backend=filesystem).no_9p_export.smallpages.no_pci_assignable.qcow2.virtio_blk.smp2.virtio_net',
                                   'guest-os.cfg': 'Linux.JeOS.20.x86_64',
                                   'machines.cfg': 'i440fx',
                                   'subtests.cfg': '(subtest=type_specific).(subtest=io-github-autotest-qemu).(subtest=qemu_cpu).cpuid.default.vendor.kvm.cpu.unset.(host_cpu_vendor=unknown).(qemu_flavor=unknown)',
                                   'tests.cfg': 'qemu_kvm_jeos_quick'},
                '_short_name_map_file': {'guest-hw.cfg': 'filesystem.no_9p_export.smallpages.no_pci_assignable.qcow2.virtio_blk.smp2.virtio_net',
                                         'guest-os.cfg': 'Linux.JeOS.20.x86_64',
                                         'machines.cfg': 'i440fx',
                                         'subtests.cfg': 'type_specific.io-github-autotest-qemu.qemu_cpu.cpuid.default.vendor.kvm.cpu.unset.unknown.unknown',
                                         'tests.cfg': 'qemu_kvm_jeos_quick'},
                'auto_cpu_model': 'no',
                'backup_dir': 'images/',
                'backup_image': 'no',
                ...
                'monitor_type': 'human',
                'monitors': 'hmp1',
                'name': 'qemu_kvm_jeos_quick.(image_backend=filesystem).no_9p_export.smallpages.no_pci_assignable.qcow2.virtio_blk.smp2.virtio_net.Linux.JeOS.20.x86_64.i440fx.(subtest=type_specific).(subtest=io-github-autotest-qemu).(subtest=qemu_cpu).cpuid.default.vendor.kvm.cpu.unset.(host_cpu_vendor=unknown).(qemu_flavor=unknown)',
                'netdev_peer_re': '\\s{2,}(.*?): .*?\\\\\\s(.*?):',
                'netdst': 'virbr0',
                'nettype': 'user',
                'nic_model': 'virtio',
                ...
                'shell_port': '22',
                'shell_prompt': '^\\[.*\\][\\#\\$]\\s*$',
                'shortname': 'qcow2.virtio_blk.smp2.virtio_net.JeOS.20.x86_64.io-github-autotest-qemu.qemu_cpu.cpuid.default.vendor.kvm.cpu.unset',
                'shutdown_command': 'shutdown -h now',
                'skip_cluster_leak_warn': 'no',
                'skip_image_check_during_running': 'no',
                ...
                'store_vm_register': 'yes',
                'strict_mode': 'no',
                'subtest': 'io-github-autotest-qemu.qemu_cpu',
                'take_regular_screendumps': 'yes',
                'test_timeout': '14400',
