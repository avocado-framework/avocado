    ...
    def _run(self):
        ...
        for test_status, fail_class in summary.iteritems():
            if not mapping[test_status]:
                exit_status |= exit_codes.AVOCADO_TESTS_FAIL
            if fail_class == 'TestTimeoutInterrupted':
                exit_status |= exit_codes.AVOCADO_JOB_INTERRUPTED
            elif fail_class == 'TestTimeoutSkip':
                exit_status |= exit_codes.AVOCADO_JOB_INTERRUPTED
