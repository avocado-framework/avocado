...
class Job:
    ...
    def __init__(self, config=None, test_suites=None):
        ...
        :type config: dict
        :param suites_configs: A list with each test suite configuration. If is
                               None the main job config will be used as
                               reference for only one test suite.
