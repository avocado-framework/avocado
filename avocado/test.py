...
class Test(unittest.TestCase):
    ...
    def get_resolution_order():
        """
        Defines the params resolution order. The default is:
        1. /self/* - convention for test variants
        2. /self   - convention for test defaults
        3. /*      - other locations
        :return: list of paths used to obtain params
        """
        return ["/self/*", "/self", "/*"]
