...
class BuggyTest(Test):
    ...
    That means it is possibly a buggy test, but it could also be a random buggy python module.
    """
...
class NotATest(Test):
    ...
    """
    Either a non executable python module, or a regular, non executable file
    """
    ...
    def action(self):
        e_msg = ('File %s is not executable and does not contain an avocado test class in it ' % self.name)
