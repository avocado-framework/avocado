...
def make_temp_script(name, content, prefix='avocado_script', mode=0775):
    ...
    :return: the script path.
    """
    scpt = Script(name, content, temp=prefix, mode=mode)
    scpt.save()
    return scpt.path
