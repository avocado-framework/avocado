...
class Image:
    ...
    def _get_metadata_for_asset(asset_path):
        """
        Reads and returns the metadata for a given asset path.

        :param asset_path: The path to the asset file.
        :returns: A dictionary with the metadata or None on error.
        """
    ...
    def _metadata_matches(metadata, name, version, build, compatible_arches):
        """
        Checks if the given metadata dictionary matches the search criteria.

        :param metadata: The metadata dictionary to check.
        :param name: The name to match.
        :param version: The version to match.
        :param build: The build to match.
        :param compatible_arches: A list of compatible architectures to match.
    ...
    def _find_cached_image(
        ...
        """
        Internal helper to find a matching cached image.

        :param cache_dirs: List of directories to search for cached assets.
        :returns: An Image instance if a cached image is found, otherwise None.
        """
