...
class Iscsi(object):
    ...
    def export_target(self):
        ...
        try:
            output = process.system_output(cmd)
        except exceptions.CmdError:   # In case service stopped
            process.system("service tgtd restart")
            output = process.system_output(cmd)
