...
class Variants(CLICmd):
    ...
    def run(self, config):
        ...
        tree = future.get('variants.tree')
        summary = future.get('variants.summary')
        variants = future.get('variants.variants')
        contents = future.get('variants.contents')
        inherit = future.get('variants.inherit')

        err = None
        if tree and future.get('variants.debug'):
        ...
        json_variants_dump = future.get('variants.json_variants_dump')
