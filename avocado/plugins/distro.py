...
class Distro(CLICmd):
    ...
    def run(self, config):
        ...
        name = future.get('distro.distro_def_name')
        version = future.get('distro.distro_def_version')
        release = future.get('distro.distro_def_release')
        arch = future.get('distro.distro_def_arch')
        distro_type = future.get('distro.distro_def_type')
        path = future.get('distro.distro_def_path')
        if future.get('distro.distro_def_create'):
