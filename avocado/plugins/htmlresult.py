...
class ReportModel(object):
    ...
    def results_dir_basename(self):
        return os.path.basename(self._results_dir(False))
    ...
    def _get_sysinfo(self, sysinfo_file):
        sysinfo_path = os.path.join(self._results_dir(False),
    ...
    def tests(self):
        ...
        results_dir = self._results_dir(False)
        for t in test_info:
    ...
    def sysinfo(self):
        sysinfo_list = []
        base_path = os.path.join(self._results_dir(False),
                                 'sysinfo', 'pre')
        try:
