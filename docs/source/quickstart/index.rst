...
**output plugins**. If you wanted something more sophisticated, visit our
plugins section.
...
information per each job or even between tests. This is very useful when later
we want to know what caused the test’s failure.
...
Avocado has a plugin system that can be used to extended it in a clean way. The
