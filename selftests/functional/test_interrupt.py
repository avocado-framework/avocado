...
class InterruptTest(unittest.TestCase):
    ...
    def test_badly_behaved_sigint(self):
        ...
        if not wait.wait_for(self._no_test_in_process_table, timeout=2):
    ...
    def test_badly_behaved_sigterm(self):
        ...
        # This test has to be terminated when the main process
    ...
    def test_well_behaved_sigint(self):
        ...
        # This test will not ignore SIGINT, so it will
