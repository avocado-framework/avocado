...
class OutputTest(unittest.TestCase):
    ...
    def test_print_to_std(self):
        ...
        res = json.loads(result.stdout)
        testdir = res["tests"][0]["logdir"]
        # Some race conditions on systems with slow I/O was observed
        # while reading from the files generated by the avocado test
        # runner command.  Let's attempt to sync the file buffers
        # before reading from the output file
        utils_path.sync_attempt()
