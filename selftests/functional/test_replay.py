...
class ReplayTests(unittest.TestCase):
    ...
    def test_run_replay_statusfail(self):
        ...
        expected_rc = exit_codes.AVOCADO_ALL_OK
        result = self.run_and_check(cmd_line, expected_rc)
        msg = '(1/4) examples/tests/passtest.py.variant1:  SKIP\n ' \
              '(2/4) examples/tests/passtest.py.variant2:  SKIP\n ' \
              '(3/4) examples/tests/passtest.py.variant3:  SKIP\n ' \
              '(4/4) examples/tests/passtest.py.variant4:  SKIP'
        self.assertIn(msg, result.stdout)
    ...
    def test_run_replay_external_runner(self):
        ...
        result = self.run_and_check(cmd_line, expected_rc)
        msg = "Overriding the replay 'external-runner' with external-runner "\
