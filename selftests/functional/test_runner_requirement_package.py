...
class RunnableRun(unittest.TestCase):
    ...
    @unittest.skipIf(not os.getenv('CI') and os.getenv('CI') not in ['true'],
                     "This test runs on CI environments only as it depends on"
                     " the system package manager, and some environments"
