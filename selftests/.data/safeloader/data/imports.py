...
from path import (
    parent6 as asparent6,
)  # .module => path; .names[0].asname => asparent6; .names[0].name => path.parent6
...
from .path.parent10 import (
    Class10 as AsClass10,
)  # .module => path.parent10; .names[0].asname => AsClass10; .names[0].name => Class10
